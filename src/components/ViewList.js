...
const ViewList = () => {
    ...
    const fetchList = (id) =>{
        try{
            axios.get(`https://event-management-app-backend-production.up.railway.app/list/${id}`)
            .then(response=>{
    ...
    const fetchTasks = async (id) =>{
        try{
            axios.get(`https://event-management-app-backend-production.up.railway.app/list/${id}/tasks`)
            .then(response=>{
    ...
    const deleteTask = async (id) =>{
        try{
            axios.delete(`https://event-management-app-backend-production.up.railway.app/task/${id}/delete`)
            .then(response=>{
    ...
    const handleCheckboxChange = (taskId, isCompleted) =>{
        ...
        try{
            axios.post(`https://event-management-app-backend-production.up.railway.app/task/${taskId}/completion`, completion)
            .then(response=>{
                console.log(response)
            })
            .catch(error=>console.log(error))
