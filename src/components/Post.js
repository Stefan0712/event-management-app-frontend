...
const Post = () => {
    ...
    const deleteComment = async (id) =>{
        try{
            axios.delete(`http://localhost:5000/comment/${id}/delete`)
            .then(response=>{
    ...
    const deletePost = async (id) =>{
        try{
            axios.delete(`http://localhost:5000/post/${id}/delete`)
            .then(response=>{
                console.log(response)
                navigate('/social')
            })
    ...
    const handlePostUpdate = async () =>{
        ...
        console.log(post)
        try {
            const response = await axios.post(`http://localhost:5000/post/${postData._id}/update`, post);
