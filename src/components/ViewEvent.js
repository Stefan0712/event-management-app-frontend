...
const ViewEvent = () => {
    ...
    useEffect(()=>{
        ...
        try{
            axios.get(`http://event-management-app-backend.railway.internal/view-event/${id}`)
            .then(response=>{
    ...
    const handleJoinEvent = () =>{
        try{
            axios.post(`http://event-management-app-backend.railway.internal/join-event/${id}`, {userId: user._id})
            .then(response=>{
